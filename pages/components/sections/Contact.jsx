                ...
                <div className='border-0 border-red-500'>
                    ...
                    <div className='flex justify-around w-full m-auto mt-20 text-white border-0 border-red-500'>
                        <div className='flex border-0 border-red-500 xl:space-x-20 sm1:flex-col xl:flex-row sm1:space-y-2 md:space-y-8 xl:space-y-0'>
                            <a href="mailto:hs6868@srmist.edu.in" className='border-0 border-red-500'>
                                <div className='flex flex-row space-x-4 sm1:hidden md:flex'>
                                    ...
                                    <div className='leading-[1rem]'>
                                        <p className='sm1:text-sm md:text-lg'>hs6868@srmist.edu.in</p>
                                        <p className='sm1:text-xs md:text-sm text-white/50'>University Email</p>
                                    </div>
                                </div>
                            </a>
                            <a href="tel:+91 9828477222" className='border-0 border-red-500'>    
                                <div className='flex flex-row space-x-4'>
                                    ...
                                    <div className='leading-[1rem]'>
                                        <p className='sm1:text-md md:text-lg'>+91 9828477222</p>
                                        <p className='sm1:text-sm md:text-sm text-white/50'>Call me at</p>
                                    </div>
                                </div>
                            </a>    
                            <a href="mailto:sharmaslov@gmail.com" className='border-0 border-red-500'>
                                <div className='flex flex-row space-x-4'>
                                    ...
                                    <div className='leading-[1rem]'>
                                        <p className='sm1:text-md md:text-lg'>sharmaslov@gmail.com</p>
                            ...
                            <div className='flex space-x-4 border-0 border-red-500 sm1:pt-8 md:pt-4 lg:pt-0 md:text-3xl sm1:text-3xl lg:text-2xl'>
                                <a className='text-blue-400 rounded-full sm1:p-2 md:p-4 bg-blue-400/20' href="https://github.com/himuexe" target="_blank" rel="noreferrer" ><FiGithub /></a>
                                <a className='text-blue-400 rounded-full sm1:p-2 md:p-4 bg-blue-400/20' href="https://www.instagram.com/" target="_blank" rel="noreferrer"><FiInstagram /></a>
                                <a className='text-blue-400 rounded-full sm1:p-2 md:p-4 bg-blue-400/20' href="https://www.linkedin.com/in/himanshuexe" target="_blank" rel="noreferrer"><FaLinkedinIn /></a>
                                <a className='text-blue-400 rounded-full sm1:p-2 md:p-4 bg-blue-400/20' href="https://drive.google.com/file/d/1jkDWzEOzGzJsZXVc-jDHgLHSZENnPu-x/view?usp=drive_link" target="_blank"><IoDocumentTextOutline /></a>
                            </div>
                        </div>           
                    </div>
                </div>    
                        ...
                        <div className='sm1:w-full lg:w-3/5 lg:mt-96 xl:mt-60 sm1:mt-12 md:mt-28 xl:w-full'>
                            <div className='flex flex-col w-full border-0 border-blue-500 sm1:mt-4 md:mt-0 md:space-y-4'>
                                <div className='flex xl:space-x-20 sm1:flex-col xl:flex-row sm1:space-y-2 md:space-y-8 xl:space-y-0'>
                                    <a href="mailto:hs6868@srmist.edu.in">
                                        <div className='flex flex-row space-x-4 sm1:hidden md:flex'>
                                            <div className='text-blue-400 rounded-full md:p-3 sm1:p-2 sm1:text-2xl lg:text-4xl md:text-5xl bg-blue-400/30'><FaGraduationCap /></div>
                                            <div className='leading-[1rem]'>
                                                <p className='sm1:text-sm md:text-lg'>hs6868@srmist.edu.in</p>
                                ...
                                <div className='flex sm1:flex-col md:flex-row lg:flex-col xl:flex-row'>
                                    <a href="mailto:sharmaslov@gmail.com">
                                        <div className='flex flex-row space-x-4'>
