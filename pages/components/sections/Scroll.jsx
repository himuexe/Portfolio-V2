          ...
          <div className='overflow-hidden border-0 border-gray-500 lg:w-3/5 sm3:w-full'>
            { scrollData.map((screen,i) => (
                ...
                >
                  ...
                  />
                  <div>
                    <Image src={screen.imgUrl} key={screen.imgUrl} alt='' height={200} width={300} className='h-64 m-auto transition transform  sm3:w-72 sm3:h-72 box-shadow-out sm1:w-64 md:w-4/5 md:h-100 lg:hidden slide-right'></Image>
                  </div>
                </motion.div>
            ))}
          </div>
            ...
            <div className='h-full xl:w-80 rounded-xl lg:w-80'>
                <div className='p-2 bg-stone-950 rounded-3xl'>
                    <div className='h-full overflow-hidden bg-black rounded-3xl box-shadow-in'>
                        ...
                        <Image src={scrollData[currentImage].imgUrl} key={scrollData[currentImage].imgUrl} alt='' height={500} width={800} className='object-cover p-2 pt-0 transition transform duration-[1000ms] slide-right  h-100'></Image>
                    </div>
                </div>
            </div>
          </div>
